...
export function StarButton({
  ...
  const content = (
    <>
      ...
      />
      <div
        className="absolute inset-0 dark:border-white/15 border-white/20 z-[4] overflow-hidden rounded-[inherit]"
  ...
  const sharedClassName = cn(
    "relative z-[3] overflow-hidden h-12 px-8 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-base font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button",
    className,
  );
