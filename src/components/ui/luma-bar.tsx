...
import { Home, Grid3X3, Calculator, TrendingUp, FileText, Phone, Mail, MessageSquare } from "lucide-react";
...
const items: NavItem[] = [
  ...
  { id: 5, icon: <FileText size={24} />, label: "Apply", href: "#apply" },
];
...
const LumaBar = () => {
  ...
  return (
    <>
      {/* Contact popup — portal-style, outside the bar entirely */}
      <AnimatePresence>
        {contactOpen && (
          <motion.div
            data-contact-popup
